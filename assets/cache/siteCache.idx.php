...
$c['site_status'] = "1";
$c['site_unavailable_message'] = "サイトは現在メンテナンス中です。しばらくお待ちください。";
$c['track_visitors'] = "0";
...
$c['use_captcha'] = "0";
$c['captcha_words'] = "isono,fuguta,sazae,masuo,katsuo,wakame,tarao,namihei,fune,tama,mokuzu,umihei,norisuke,taiko,ikura,sakeo,norio,isasaka,hanazawa,hanako,anago";
$c['emailsender'] = "mike@webprogramming.ca";
$c['emailsubject'] = "ログイン情報のお知らせ";
...
$c['tinymce_custom_plugins'] = "save,advlist,clearfloat,style,fullscreen,advimage,paste,advlink,media,contextmenu,table";
$c['tinymce_custom_buttons1'] = "undo,redo,|,bold,forecolor,backcolor,strikethrough,formatselect,fontsizeselect,pastetext,pasteword,code,|,fullscreen,help";
$c['tinymce_custom_buttons2'] = "image,media,link,unlink,anchor,|,justifyleft,justifycenter,justifyright,clearfloat,|,bullist,numlist,|,blockquote,outdent,indent,|,table,hr,|,styleprops,removeformat";
$c['tinymce_css_selectors'] = "左寄せ=justifyleft;右寄せ=justifyright";
$c['tree_show_protected'] = "0";
$c['rss_url_news'] = "http://feeds2.feedburner.com/modxjp";
$c['rss_url_security'] = "http://feeds2.feedburner.com/modxjpsec";
$c['validate_referer'] = "1";
$c['datepicker_offset'] = "-10";
$c['xhtml_urls'] = "1";
$c['allow_duplicate_alias'] = "1";
$c['automatic_alias'] = "0";
$c['datetime_format'] = "YYYY/mm/dd";
$c['warning_visibility'] = "0";
$c['remember_last_tab'] = "1";
$c['site_id'] = "4ca16e292d155";
...
';
$c['ContactFormReport'] = 'ウェブサイトの問い合わせフォームからの送信です。
...
--------------------------------------------------------
';
$c['reflect_month_tpl'] = '<a href="[+url+]" title="[+year+] [+month+]" class="reflect_month_link">[+month+] [+year+]</a>';
...
# Return
return $output;';
$s['eFormProps'] = '&sendAsText=テキストで送る;string;1 ';
...
$p['Inherit Parent TemplateProps'] = '&inheritTemplate=Inherit Template;list;From Parent,From First Sibling;From First Sibling ';
...
// Run the main code
$asset_path = MODX_BASE_PATH . \'assets/plugins/managermanager/mm.inc.php\';
include($asset_path);';
...
';
$p['Quick Manager+Props'] = '&jqpath=Path to jQuery;text;assets/js/jquery-1.3.2.min.js &loadmanagerjq=Load jQuery in manager;list;true,false;false &loadfrontendjq=Load jQuery in front-end;list;true,false;true &noconflictjq=jQuery noConflict mode in front-end;list;true,false;true &loadtb=Load modal box in front-end;list;true,false;true &tbwidth=Modal box window width;text;80% &tbheight=Modal box window height;text;90% &hidefields=Hide document fields from front-end editors;text;parent &hidetabs=Hide document tabs from front-end editors;text; &hidesections=Hide document sections from front-end editors;text; &addbutton=Show add document here button;list;true,false;true &tpltype=New document template type;list;parent,id,selected;parent &tplid=New document template id;int;3  &custombutton=Custom buttons;textarea; &1=undefined;; &managerbutton=Show go to manager button;list;true,false;true &logout=Logout to;list;manager,front-end;manager &disabled=Plugin disabled on documents;text; &autohide=Autohide toolbar;list;true,false;true &editbuttons=Inline edit buttons;list;true,false;false &editbclass=Edit button CSS class;text;qm-edit &newbuttons=Inline new resource buttons;list;true,false;false &newbclass=New resource button CSS class;text;qm-new &tvbuttons=Inline template variable buttons;list;true,false;false &tvbclass=Template variable button CSS class;text;qm-tv ';
$p['Search Highlight'] = '/*
  ------------------------------------------------------------------------
